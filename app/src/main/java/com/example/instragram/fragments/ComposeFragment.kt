...
class ComposeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //Set Onclicklistners and setup logic
       ivPreview = view.findViewById(R.id.imageView)
        view.findViewById<Button>(R.id.submit_button).setOnClickListener{
            ...
            if(photoFile!= null )
            {
                ...
                Log.e(MainActivity.TAG,"Error while Taking images!")
            }
        }

        view.findViewById<Button>(R.id.picture_button).setOnClickListener{
    ...
    private fun submitPost(description : String,user: ParseUser,file : File) {
        ...
        post.saveInBackground{ exception ->
            if( exception != null){
                ...
                //TODO :Resetting the Edit textfile to b empty
